	...
	g_diff_levels = 
	{
		...
		[2] = -- ID уровня сложности
		{
			...
			{		
				...
				damage_multipliers	= 
				{
					[g_damage_type.GUNSHOT]		= 1.4,
					[g_damage_type.KNOCK]		= 1.4,
					[g_damage_type.BLAST]		= 1.4,
					[g_damage_type.BURN]		= 1.4,
					[g_damage_type.BANG]		= 1.4,
					[g_damage_type.ELECTRO]		= 1.4,
					[g_damage_type.SHPR]		= 1.4,				
				},
			...
			human_controlled_actors = 
			{
				...
				damage_multipliers	= 
				{
					[g_damage_type.GUNSHOT]		= .6,
					[g_damage_type.KNOCK]		= .6,
					[g_damage_type.BLAST]		= .6,
					[g_damage_type.BURN]		= .6,
					[g_damage_type.BANG]		= .6,
					[g_damage_type.ELECTRO]		= .6 * 4.5,
					[g_damage_type.SHPR]		= .6,				
				},
