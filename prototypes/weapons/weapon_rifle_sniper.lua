...
weapon_rifle_sniper.properties_design = utils.merge_arrays(weapon_basic.properties_design, {
	...
	{ "priority",			6.5 }, -- приоритет оружи€
--	{ "icon_id",			8 }, -- иконка дл€ HUD
	
	{ "loaded_ammo",		5 },	-- кол-во зар€женных патронов в стволе (не больше чем m_clip_size)
...
---------------------------------------
-- врем€ через которое, 
-- можно не дожида€сь начала анимации сделать новый выстрел,
-- если nil, то об€зательно ждем конца всей анимации
...
weapon_rifle_sniper.m_shot_point_name			= "#shoot_point"			-- точка прив€зки эффекта в модели
...
-- „увствительность мыши (коэффициент масштабировани€)
