...
weapon_nailgun.properties_design = utils.merge_arrays(weapon_basic.properties_design, {
	...
	{ "priority",			5 }, -- приоритет оружи€
--	{ "icon_id",			8 }, -- иконка дл€ HUD
	
	{ "loaded_ammo",		33 },	-- кол-во зар€женных патронов в стволе (не больше чем m_clip_size)
...
weapon_nailgun.m_shot_point_name			= "#shoot_point"			-- точка прив€зки эффекта в модели
