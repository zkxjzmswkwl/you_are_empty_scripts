...
actor_protivogaz.properties_design = utils.merge_arrays(actor_basic.properties_design, {
	...
	{ "jump_height",			20	  },
	{ "turn_speed",				{380.0, 380.0, 380.0}  }, -- угловая скорость поворота
	
	-- праметры зрения
	{ "view_fov",				70	  },	-- угол обзора (град) 
	{ "view_dist",				100	  },	-- максимальная дальность зрения (м)
...
actor_protivogaz.params.attack_info[0] = {
	...
	offset_pos			= {0, 0, 1.60}, -- не используется, если указан 'shoot_point_tag'
