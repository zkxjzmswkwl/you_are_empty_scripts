...
actor_budyonovets.properties_design = utils.merge_arrays(actor_basic.properties_design, {
	...
	{ "jump_height",			30	  },
	{ "turn_speed",				{280.0, 280.0, 380.0}  }, -- углова€ скорость поворота
	
	-- праметры зрени€
	{ "view_fov",				70	  },	-- угол обзора (град) 
	{ "view_dist",				2500	  },	-- максимальна€ дальность зрени€ (м)
	{ "vision_fade_in_time",			700 },	-- реакци€ на по€вление врага
	{ "vision_fade_out_time",			700 },	-- реакци€ на изчезновение врага
...
actor_budyonovets.params.attack_info[1] = {
	...
	offset_pos			= {0.70, 0, 1.70}, -- не используетс€, если указан 'shoot_point_tag'
