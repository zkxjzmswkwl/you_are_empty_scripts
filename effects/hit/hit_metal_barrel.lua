...
decal_desc = {
		width = 3,
		depth = 4,
		textures = {"WLM_MetBul.tga", "WLM_MetBul2.tga", "WLM_MetBul3.tga", "WLM_MetBul4.tga",},
		decal_type = "bland",
		life_time = 15,
		fade_time = 2,
}
...
sound_desc = {
	file_name = { "bullet_hit_metal_bo4ka7.wav", "bullet_hit_metal_bo4ka0.wav", "bullet_hit_metal_bo4ka1.wav", "bullet_hit_metal_bo4ka2.wav", "bullet_hit_metal_bo4ka3.wav", "bullet_hit_metal_bo4ka4.wav", "bullet_hit_metal_bo4ka6.wav", },
	volume = -0.5,
	max_distance = 35*64,
}
