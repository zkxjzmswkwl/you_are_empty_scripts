...
sound_desc = {
	file_name = { "bullet_hit_derevo_yas4ik_small3.wav", "bullet_hit_derevo_yas4ik_small0.wav", "bullet_hit_derevo_yas4ik_small1.wav", "bullet_hit_derevo_yas4ik_small2.wav", },
	volume = -0.5,
	min_distance = 5*64,
	max_distance = 35*64,
}
