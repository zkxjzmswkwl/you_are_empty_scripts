...
sound_desc = {
	file_name = { "bullet_hit_metal_katalka_kolyaska3.wav", "bullet_hit_metal_katalka_kolyaska0.wav", "bullet_hit_metal_katalka_kolyaska1.wav", "bullet_hit_metal_katalka_kolyaska2.wav", },
	volume = -0.5,
	max_distance = 35*64,
}
