...
-------------------------------------------------------------------
-- ѕредварительна€ инициализаци€ игры
-------------------------------------------------------------------

-- типы атак дл€ »» персонажей
ATTACK_MELEE = 0; -- атака с близкого рассто€ни€ при непосредственном контакте
ATTACK_JUMP = 1; -- атака с прыжка
ATTACK_DISTANT = 2; -- атака на рассто€нии при помощи оружи€
...
function sv_game_init()
	...
	-- регистраци€ событий
	-- дл€ »», которого тригер "позвал" идти в его позицию);
	engine.register_event("EVENT_WALK_HERE",	"pos_to_go = %vec3");
		
	-- actions и callbacks дл€ актеров и контроллеров
	...
	-- установить начальное значение дл€ генератора случайных чисел
