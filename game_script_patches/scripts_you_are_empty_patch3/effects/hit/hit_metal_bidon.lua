...
sound_desc = {
	file_name = { "klyu4_kick_metal_bo4ka1.wav", "klyu4_kick_metal_bo4ka2.wav", "klyu4_kick_metal_bo4ka3.wav", "bullet_hit_metal_bo4ka2.wav", "bullet_hit_metal_bo4ka3.wav", "klyu4_kick_metal_bo4ka4.wav", },
	volume = -0.5,
	min_distance = 5*64,
	max_distance = 35*64,
	channel = "effect_hit",
